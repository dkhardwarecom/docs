...
| paymentMethod | | [Payment method](https://github.com/dkhardwarecom/docs/blob/main/partnerApi/orders.md#payment-method)  | Code field is sufficient | Payment method |
