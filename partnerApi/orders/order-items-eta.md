...
| itemsEta |  | Array of [Item ETA](https://github.com/dkhardwarecom/docs/blob/main/partnerApi/order-items-eta.md#Item-ETA)  | | Estimated Time of Arrival for order items. |
